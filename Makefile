...
# coq_makefile Arith.v Exceptions.v ExceptionsTwoCont.v Heap.v LambdaCBName.v LambdaCBNameArith.v LambdaCBNeedArith.v LambdaCBV.v LambdaCBVArith.v ListIndex.v StateGlobal.v StateLocal.v Tactics.v -o Makefile 
#
